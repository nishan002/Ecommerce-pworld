                                            ...
                                            <form class="form-horizontal" action="{{route('subcategory.store')}}" method="post">
                                                        ...
                                                        <div class="col-sm-12 col-xs-12">
                                                            ...
                                                            <div>
                                                                <select name="category_id" class="custom-select font-14 m-b-5" data-style="btn-default btn-outline">
                                                                    <option  data-tokens="Category" > {{$sub_categories->category->category_name}} </option>
                                                ...
                                                <div class="col-sm-12 col-xs-12">
                                                    <div class="form-group m-b-15">
                                                        ...
                                                        <div>
                                                            <input type="text" class="form-control font-14" name="sub_category_name" value="{{$sub_categories->sub_category_name}}"  placeholder="Name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-xs-12">
                                                    <div class="form-group m-b-15">
                                                        ...
                                                        <div>
                                                            <input type="text" class="form-control font-14" name="category_bangla_name" value="{{$sub_categories->category_bangla_name}}"  placeholder="Name">
                                                        </div>
                                                    </div>
                                                </div>
